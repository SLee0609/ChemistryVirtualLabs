...
// activity where question 2 of calorimetry cacl2 lab is explained
public class CalorimetryCacl2Q2Exp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_calorimetry_cacl2_q2_exp);
        ...
        // next used to go to CalorimetryCacl2Q3
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // go to CalorimetryCacl2Q3 activity
