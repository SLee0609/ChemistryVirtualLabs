...
// activity where users see calorimetry lab for nh4no3
public class CalorimetryNh4no3Exp extends AppCompatActivity {

    // text that displays the current temperature of water
    private TextView temp;
    // button used to start temperature changes
    private Button start;
    // button used to go to CalorimetryNh4no3Stats activity - initially set to gone visibility
    private Button next;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_calorimetry_nh4no3_exp);
        ...
        final double TEMPCHANGE = (Math.round(((NH4NO3HEAT * GRAM * (1 / NH4NO3MM)) / (-WATERMASS * WATERHEAT * 0.001)) * 10) / 10.0) + 0.1;
                            ...
                            while (currentTemp != FINALTEMP) {
                                ...
                                runOnUiThread(new Runnable() {
                                    ...
                                    public void run() {
                                        ...
                                        // if currentTemp is lower than FINALTEMP
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                openCalorimetryNh4no3Stats(GRAM, INITIALTEMP, FINALTEMP);
            }
        });
    }
    ...
    public void openCalorimetryNh4no3Stats(double gram, double initialTemp, double finalTemp) {
        Intent intent = new Intent(this, CalorimetryNh4no3Stats.class);
        // passes gram, initialTemp, finalTemp, status, and score to the new activity
        Bundle b = new Bundle();
