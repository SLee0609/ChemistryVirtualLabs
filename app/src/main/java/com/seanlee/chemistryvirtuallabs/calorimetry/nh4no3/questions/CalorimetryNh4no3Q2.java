...
// activity where users answer question 2 of calorimetry nh4no3 lab
public class CalorimetryNh4no3Q2 extends AppCompatActivity {
    ...
    private ImageView x;
    // next used to go to CalorimetryNh4no3Q2Exp - initially set to invisible
    private Button next;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_calorimetry_nh4no3_q2);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // go to CalorimetryNh4no3Q2Exp activity
                openCalorimetryNh4no3Q2Exp(GRAM, INITIALTEMP, FINALTEMP, score);
    ...
    // changes activity to CalorimetryNh4no3Q2Exp
    public void openCalorimetryNh4no3Q2Exp(double gram, double initialTemp, double finalTemp, int score) {
        Intent intent = new Intent(this, CalorimetryNh4no3Q2Exp.class);
