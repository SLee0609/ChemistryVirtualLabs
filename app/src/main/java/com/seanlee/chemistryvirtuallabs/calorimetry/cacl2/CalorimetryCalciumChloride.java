...
// activity where users select the amount of cacl2 to use in calorimetry
public class CalorimetryCalciumChloride extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_calorimetry_calcium_chloride);
        ...
        // if done is clicked
            ...
            public void onClick(View v) {
                ...
                if (chosenGram >= 1) {
                    ...
                    openCalorimetryCacl2Exp(chosenGram);
                } else {
    ...
    // changes activity to CalorimetryCacl2Exp
    public void openCalorimetryCacl2Exp(double chosenGram) {
        Intent intent = new Intent(this, CalorimetryCacl2Exp.class);
