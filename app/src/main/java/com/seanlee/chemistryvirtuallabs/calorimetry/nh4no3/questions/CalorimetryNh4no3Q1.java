...
// activity where users answer question 1 of calorimetry nh4no3 lab
public class CalorimetryNh4no3Q1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_calorimetry_nh4no3_q1);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // go to CalorimetryNh4no3Q1Exp activity
                openCalorimetryNh4no3Q1Exp(GRAM, INITIALTEMP, FINALTEMP, score);
    ...
    // changes activity to CalorimetryNh4no3Q1Exp
    public void openCalorimetryNh4no3Q1Exp(double gram, double initialTemp, double finalTemp, int score) {
        Intent intent = new Intent(this, CalorimetryNh4no3Q1Exp.class);
