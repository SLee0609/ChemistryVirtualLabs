...
// activity where question 3 of calorimetry cacl2 lab is explained
public class CalorimetryCacl2Q3Exp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_calorimetry_cacl2_q3_exp);
        ...
        if (String.valueOf(q2ans).length() == 3) {
            q3exp.setText("The answer is " + ans + "\nBecause we assume that there is only heat transfer between water and the compound, q of water = -q of the compound\'s dissolution.\nUsing the answer from question 2, +" + q2ans + "0 kJ = -ΔHsolution * " + gram + " * (1 mol / 110.98 g)\nΔHsolution = " + ans);
        } else {
            q3exp.setText("The answer is " + ans + "\nBecause we assume that there is only heat transfer between water and the compound, q of water = -q of the compound\'s dissolution.\nUsing the answer from question 2, +" + q2ans + " kJ = -ΔHsolution * " + gram + " * (1 mol / 110.98 g)\nΔHsolution = " + ans);
        }

        // next used to go to CalorimetryCacl2Q4
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // go to CalorimetryCacl2Q4 activity
